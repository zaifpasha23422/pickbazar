export default function Register(){
    return(
        ...
        <div className="flex flex-col items-center gap-5">
            ...
            <p>By signing up, you agree to our <span className="text-green-700 underline">terms</span> & <span className="text-green-700 underline"> policy </span></p>
        </div>
        <form className="flex flex-col items-center gap-5 pt-8" action="">
            <div>
                <label htmlFor="name">Name</label>
                <br />
                <input type="text" className="border-2 h-10 w-100 rounded-xl"/>
            </div>
             <div>
        ...
        <div className="flex justify-center pt-10">
            <p>Already have an account? <button className="text-green-700 underline">Login</button></p>
        </div>
        </div>
    )
}